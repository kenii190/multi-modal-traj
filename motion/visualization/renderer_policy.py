...
shader_pbr2.set_uniform("metallic", 0.2)
...
pose.set_root_position(gx.vec3(0, 16.0, 0.0))
...
player_window = PlayerWindow("Player (Policy)", 2)
...
#---------------------------
def render_player(motion, z_points):
